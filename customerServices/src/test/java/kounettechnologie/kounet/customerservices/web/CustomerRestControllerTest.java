package kounettechnologie.kounet.customerservices.web;
...
import kounettechnologie.kounet.customerservices.service.CustomerService;
...
class CustomerRestControllerTest {
    ...
    void setUp() {
        this.customers = List.of(
                CustomerDTO.builder().id(1L).firstName("oumar").lastName("kounet").email("ko@gmail.com").build() ,
                CustomerDTO.builder().id(2L).firstName("alpha").lastName("diallo").email("dia@gmail.com").build(),
                CustomerDTO.builder().id(3L).firstName("yas").lastName("Ibrahima").email("ys@gmail.com").build()
        );
    }
    ...
    void shouldSaveCustomer() throws Exception {
        ...
        String expected = """
                {
                  "id":1, "firstName":"Mohamed", "lastName":"oumar", "email":"oumar@gmail.com"
                }
                """;
