...
class CustomerIntegrationTest {
    ...
    void setUp() {
        this.customers = new ArrayList<>();
                this.customers.add(CustomerDTO.builder()
                        .id(1L).firstName("kounet").lastName("diallo").email("kounet@gmail.com").build());
        this.customers.add(CustomerDTO.builder()
                        .id(2L).firstName("Ahmed").lastName("oumar").email("omar@gmail.com").build());
        this.customers.add(CustomerDTO.builder()
                        .id(3L).firstName("bayo").lastName("yamal").email("bayo@gmail.com").build());
    }
    ...
    void shouldUpdateValidCustomer(){
        ...
        CustomerDTO customerDTO = CustomerDTO.builder()
                .id(2L).firstName("oumar").lastName("yamal").email("oumar@gmail.com").build();
